...
export const places = [
  {
    ...
    fotos: [Ceu, Chao, Flor_Vermelha, Flores_Amarelas, Monumento_Principal],
  },
  {
    img: "https://picsum.photos/220/130",
    ...
    fotos: [MON_Cafe, MON_Cima, MON_Escultura, MON_Frente, MON_Noite],
  },
  {
    img: "https://picsum.photos/220/130",
    name: "Ópera de Arame",
  ...
  },
  {
    ...
    fotos: [
      Barigui_Aerea,
      Barigui_Cara_Correndo,
      Barigui_Fauna,
      Barigui_Predios,
      Barigui_Predios_Noite,
    ],
  },
  {
    img: "https://picsum.photos/220/130",
